...
TIPS_PAGES = [
    (
        ...
        (
            ...
            f"📍 GEO: РФ / СНГ\n\n"
            f"Описание совета №1 (💣 1WIN — СКРЫТЫЙ МЕХАНИЗМ CASHBACK 300%
...
🚨 Живёт недолго, фиксится быстро.
            ...
            f"Ссылка: {https://t.me/abyzimtyt1win}\n"
        )
    ),
    (
        "💡 Совет 2 — Заголовок",
...
🚨 Проверено на 3 акках, живёт пару дней.
    ...
    (
        ...
        (
            f"📅 Актуально: Август 2025\n"
            f"📍 GEO: РФ / СНГ\n\n"
            f"Описание совета №3 (💸 АБУЗ 1WIN — 8–15К С КРУГА БЕЗ ВЛОЖЕНИЙ
...
⚙️ ЧТО ДЕЛАТЬ:
Переходишь по ссылке (офиц. сайт 1WIN внизу):
Регаешь новый акк
